...
Antes de começar, você precisará instalar em sua máquina as seguintes ferramentas: GIT :  [GIT](https://git-scm.com/)e o [VSCode] e o VSCode: (https://code.visualstudio.com/download).  E rodar em uma interface MySQL o Banco de Dados do projeto, recomendo a utilização do XAMMP. (O SCRIPT SQL JÁ ESTÁ PRONTO, E JUNTO COM AS OUTRAS DOCUMENTAÇÕES).
